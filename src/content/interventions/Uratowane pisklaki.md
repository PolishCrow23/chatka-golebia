...
Pisklęta na jedną noc do siebie zdecydowali się wziąć nasi wspaniali wolontariusze Maciej Satkiewicz i ▪️Anna Żelechowska▪️ Maciek pojechał je odebrać. Zdalnie na bieżąco wszelkich instrukcji udzielała Iga Fant, której w udało się załatwić dla maluchów miejsce w Akcja Dla Dzikich Zwierząt. Pisklaki dostały troskliwą opiekę, odpowiednie warunki, zostały nakarmione.
